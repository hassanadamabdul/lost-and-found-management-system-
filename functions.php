...
function add_post($discp, $ref_add, $pincode, $ref_uid, $ref_imgid, $date, $catg, $type)
{
    ...
    $discp = mysqli_real_escape_string($conn, $discp);
    $ref_add = (int)$ref_add; // Assuming it's an integer
    $pincode = (int)$pincode; // Assuming it's an integer
    $ref_uid = mysqli_real_escape_string($conn, $ref_uid);
    $ref_imgid = (int)$ref_imgid; // Assuming it's an integer
    $date = mysqli_real_escape_string($conn, $date);
    $catg = (int)$catg; // Assuming it's an integer
    ...
    while ($row = mysqli_fetch_array($retval, MYSQLI_ASSOC)) {
        ...
        echo "<tr>
                ...
                <td>$cat</td>
                 ...
                 <td><a href='del.php?id=$id&&type=$type' class='btn'>delete</a></td>
                 </tr>";
