    ...
    <div class="row">
        <div class="col s6">
            <div class="">
                <div class=" ">
                    <div class="card-panel blue-grey darken-4 z-depth-5">
                        <span class="white-text flow-text">SEARCH FOR LOST OR FOUND ITEM</span>
                        <br><br>
                        <form action="search1.php" method="GET">
                            <div class="input-field">
                                <input type="text" id="searchFoundItem" name="searchFoundItem">
                                <label for="searchFoundItem">Search for item</label>
                            </div>
                            <br>
